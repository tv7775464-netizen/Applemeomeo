...
-- Source-above FastAttack is used only by BNW Attack.
    ...
    if _G.FastAttackGravity_Mode ~= "BNW Attack" then return end
if not getgenv().PMT_GunFast then return end
    ...
    local speed={ ["Normal Attack"]=0.25, ["Fast Attack"]=0.15, ["Super Fast Attack"]=0.05, ["BNW Attack"]=0.1 }
