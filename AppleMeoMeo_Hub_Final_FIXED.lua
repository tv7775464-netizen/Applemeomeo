...
Attack.Pos = function(model,dist) return model and model.Position and (Root.Position - model.Position).Magnitude <= dist end
...
local Fz = {
		...
		["Logo Image"] = "rbxassetid://121601063984387",
...
gz.Image = "rbxassetid://121601063984387";
...
local Uz = function(Y)
		...
		I.Image = "rbxassetid://121601063984387";
...
function Kz.CreateMain(Y)
	...
	r.Image = "rbxassetid://121601063984387";
	...
	y.Image = "rbxassetid://121601063984387";
	...
	F.Position = UDim2.new(0, 5, 0, dz.T1 and 5 or 0);
	F.Size = UDim2.new(0, dz.T1 and 30 or 25, 0, dz.T1 and 15 or 25);
	F.Image = "rbxassetid://121601063984387";
	...
	I.BottomImage = "rbxassetid://121601063984387";
	I.CanvasSize = UDim2.new(0, 0, 0, 0);
	I.ScrollBarThickness = 5;
	I.TopImage = "rbxassetid://121601063984387";
	W.Parent = I;
	...
	L.Image = "rbxassetid://121601063984387";
	...
	function V.T(Y)
		...
		z.BottomImage = "rbxassetid://121601063984387";
		z.ScrollBarThickness = 5;
		z.TopImage = "rbxassetid://121601063984387";
		...
		function S.CreateSection(Y, d, R, r)
			...
			if a then
				...
				Q.ZIndex = 2;
				Q.Image = "rbxassetid://121601063984387";
			...
			function i.CreateToggle(Y, d)
				...
				K.Image = "rbxassetid://121601063984387";
				...
				n.Image = "rbxassetid://121601063984387";
			...
			function i.CreateButton(Y, d)
				...
				g.Image = "rbxassetid://121601063984387";
			...
			function i.CreateDropdown(Y, d)
				...
				z.Image = "rbxassetid://121601063984387";
				...
				C.BottomImage = "rbxassetid://121601063984387";
				C.CanvasSize = UDim2.new(0, 0, 0, 0);
				C.ScrollBarThickness = 5;
				C.TopImage = "rbxassetid://121601063984387";
					...
					elseif F then
						...
						for Y, d in W(L) do
							if typeof(d) == "string" then
								...
								M.ZIndex = 2;
								M.Image = "rbxassetid://121601063984387";
...
-- [[ OK Hub functions + original Gay Hub UI library ]]
-- Gay Hub feature/function code has been removed; only its UI library is retained.
-- OK Hub UI calls are adapted to the retained UI API.
...
local function WrapPage(page)
    ...
    function W:AddToggle(opt)
        opt = opt or {}
        return page.CreateToggle({
            Title = opt.Name or opt.Title or "",
    ...
    function W:AddSlider(opt)
        opt = opt or {}
        return page.CreateSlider({
            Title = opt.Name or opt.Title or "",
            Min = opt.Min or 0,
            Max = opt.Max or 100,
            Default = opt.Default or 0,
            Precise = opt.Precise or false
        }, opt.Callback)
    end

    function W:AddTextBox(opt)
        opt = opt or {}
        return page.CreateBox({
            Title = opt.Name or opt.Title or "",
            Placeholder = opt.Placeholder or "",
            Default = opt.Default,
            Number = opt.Number or false
        }, opt.Callback)
    end

    function W:AddParagraph(title, desc)
        return page.CreateLabel({
            Title = tostring(title or "") .. (desc and ("\n" .. tostring(desc)) or "")
        })
    end
...
local Tabs = {}
for _, item in ipairs(pageNames) do
    local page = Cz.T({Page_Name = item[2], Page_Title = item[2]})
    Tabs[item[1]] = WrapPage(page)
end

local Window = {
    Notify = function(_, data)
        if data and data.Content then
            print("[OK Hub] " .. tostring(data.Content))
        end
    end
}
            ...
            if DevilFruitESP then
                if string.find(v.Name, "Fruit") then   
                    if not v.Handle:FindFirstChild('NameEsp'..Number) then
                        ...
                        name.BackgroundTransparency = 1
                        name.TextStrokeTransparency = 0.5
                        name.TextColor3 = Color3.fromRGB(255, 140, 0)
...
Description = "",
Callback = function()
  for i, v in pairs(game:GetObjects("rbxassetid://121601063984387")[1]:GetChildren()) do
