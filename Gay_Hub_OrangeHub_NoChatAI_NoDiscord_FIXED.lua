...
-- Gay Hub UI tabs (Orange Hub functionality, Chat AI removed)
Tabs = {
    ...
    Race = Cz.T({ Page_Name = "Tab Upgrade Race", Page_Title = "Tab Upgrade Race" }),
...
-- Compatibility layer: Orange Hub Add* API -> Gay Hub Create* API
for _, Tab in pairs(Tabs) do
    function Tab:AddSection(title)
        return self:CreateSection(title)
    end
    function Tab:AddButton(cfg)
        cfg = cfg or {}; cfg.Title = cfg.Title or cfg.Name
        return self:CreateButton(cfg)
    end
    function Tab:AddToggle(cfg)
        cfg = cfg or {}; cfg.Title = cfg.Title or cfg.Name
        return self:CreateToggle(cfg)
    end
    function Tab:AddDropdown(cfg)
        cfg = cfg or {}; cfg.Title = cfg.Title or cfg.Name
        cfg.Values = cfg.Values or cfg.Options or {}
        return self:CreateDropdown(cfg)
    end
    function Tab:AddSlider(cfg)
        cfg = cfg or {}; cfg.Title = cfg.Title or cfg.Name
        return self:CreateSlider(cfg)
    end
    function Tab:AddTextBox(cfg)
        cfg = cfg or {}; cfg.Title = cfg.Title or cfg.Name
        return self:CreateBox(cfg)
    end
    function Tab:AddParagraph(cfg)
        cfg = cfg or {}; cfg.Title = cfg.Title or cfg.Name
        return self:CreateParagraph(cfg)
    end
