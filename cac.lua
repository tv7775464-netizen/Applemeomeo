...
redzlib = nil
pcall(function() redzlib = loadstring(game:HttpGet("https://raw.githubusercontent.com/tlredz/Library/refs/heads/main/redz-V5-remake/main.luau"))() end)
...
MinimizeButton = Window:AddMinimizeButton({
    Button = { 
        ...
        BorderSizePixel = 2,
        BorderColor3 = Color3.fromRGB(0, 174, 239) -- Xanh biển
    },
    Corner = { 
...
Tabs.Info:AddDiscordInvite({
    Name = "bnw Hub",
    Description = "Giới thiệu Pro Code Top 1 VN nhân tày code sạch 100% @taolaphongsuperbells_31715 ",
...
AttackDropdown = Tabs.Main:AddDropdown({
    ...
    Flag = "AttackDropdown",
    Options = {"Normal Attack","Fast Attack","Super Fast Attack","Bnw Attack"},
    Default = "Fast Attack",
    Callback = function(Value)
...
do
    ...
    Scroll.ScrollBarImageColor3 = Color3.fromRGB(0, 174, 239)
...
Tabs.Settings:AddToggle({
    Name = "Nguyen Sy Cuong Attack",
    Description = "Fast Attack của Nguyen Sy Cuong",
    Default = false,
    Callback = function(Value)
        _G.NguyenSyCuongAttack = Value
        if Value then
            _G.FastAttackGravity_Mode = "Fast Attack"
        end
    end
})
