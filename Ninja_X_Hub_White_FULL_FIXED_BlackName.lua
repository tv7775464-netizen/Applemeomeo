...
local Uz = function(Y)
		...
		local g = D .. ("," .. (A .. ("," .. u)));
		K.Text = "<font color=\"rgb(" .. (g .. (")\">Ninja X Hub</font> " .. dz.TitleNameNoti));
...
function Kz.CreateMain(Y)
	...
	local v = i .. ("," .. (U .. ("," .. C)));
	M.Text = "<font color=\"rgb(" .. (v .. ")\">Ninja X Hub </font> : Blox Fruits");
	...
	local S = b .. ("," .. (c .. ("," .. H)));
	M.Text = "<font color=\"rgb(" .. (S .. ")\">Ninja X Hub </font> : Blox Fruits");
	K.Name = "Background1";
	K.Parent = g;
	...
	o.Name = "thua";
	o.Color = ColorSequence.new({ ColorSequenceKeypoint.new(.0, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.0, Color3.fromRGB(255, 255, 255)) });
	...
	function V.T(Y)
		...
		function S.CreateSection(Y, d, R, r)
			if type(Y) == "table" then Y = Y[1] or Y.Title or Y.Name or "" end;
			local a = d or false;
			local w = Instance.new("Frame");
			...
			D.Name = "thua2";
			D.Color = ColorSequence.new({ ColorSequenceKeypoint.new(.0, Color3.fromRGB(255, 255, 255)), ColorSequenceKeypoint.new(1.0, Color3.fromRGB(255, 255, 255)) });
			M.Name = "Topsec";
			M.Parent = w;
			M.BackgroundColor3 = Color3.fromRGB(255, 255, 255);
			M.BackgroundTransparency = 1.0;
			...
			function i.CreateToggle(Y, d)
				local R = tostring(Y.Title or Y.Name or "");
			...
			function i.CreateDropdown(Y, d)
				local R = tostring(Y.Title or Y.Name);
				local Q = Y.Values or Y.Options;
			...
			function i.CreateBox(Y, d)
				local R = tostring(Y.Title or Y.Name) or "";
				local Q = tostring(Y.Placeholder or Y.PlaceholderText) or "";
			...
			function i.CreateParagraph(Y, d)
				Y = Y or {};
				local title = tostring(Y.Title or Y.Name or "");
				local content = tostring(Y.Content or Y.Description or "");
				local text = content ~= "" and (title .. "\n" .. content) or title;
				return i.CreateLabel({Title = text});
			end;
			function i.CreateDiscordInvite(Y, d)
				Y = Y or {};
				local title = tostring(Y.Title or Y.Name or "Discord");
				local desc = tostring(Y.Description or "");
				local invite = tostring(Y.Invite or "");
				return i.CreateButton({
					Title = title,
					Description = desc,
					Callback = function()
						if invite ~= "" and setclipboard then pcall(setclipboard, invite) end
					end
				});
			end;
			S.__currentSection = i;
			return i;
		end;
		-- Compatibility layer: merged feature code calls Create* directly on tabs.
		local function getSection()
			if S.__currentSection then return S.__currentSection end
			return S.CreateSection("General")
		end
		function S.CreateButton(Y, d) return getSection().CreateButton(Y, d) end
		function S.CreateToggle(Y, d) return getSection().CreateToggle(Y, d) end
		function S.CreateDropdown(Y, d) return getSection().CreateDropdown(Y, d) end
		function S.CreateSlider(Y, d) return getSection().CreateSlider(Y, d) end
		function S.CreateBox(Y, d) return getSection().CreateBox(Y, d) end
		function S.CreateLabel(Y, d) return getSection().CreateLabel(Y, d) end
		function S.CreateParagraph(Y, d) return getSection().CreateParagraph(Y, d) end
		function S.CreateDiscordInvite(Y, d) return getSection().CreateDiscordInvite(Y, d) end
		return S;
	end;
	az = function()
			for Y, d in pairs(I:GetChildren()) do
...
-- Main UI only: all tabs, sections, buttons, toggles and feature code removed.
local Cz = Kz.CreateMain({ Desc = "" });

-- Orange Hub feature code (Chat AI removed) --
do
  ply = game.Players
  plr = ply.LocalPlayer
...
Tabs = {
    VS = Cz.T({ Page_Name = "Tab Visual", Page_Title = "Tab Visual" }),
    Info = Cz.T({ Page_Name = "Trang Chủ", Page_Title = "Trang Chủ" }),
    Main = Cz.T({ Page_Name = "Tab General", Page_Title = "Tab General" }),
    Settings = Cz.T({ Page_Name = "Tab Setting", Page_Title = "Tab Setting" }),
    Fish = Cz.T({ Page_Name = "Tab Fishing", Page_Title = "Tab Fishing" }),
    Quests = Cz.T({ Page_Name = "Tab Stack Farm", Page_Title = "Tab Stack Farm" }),
    SeaEvent = Cz.T({ Page_Name = "Tab Sea Events", Page_Title = "Tab Sea Events" }),
    Mirage = Cz.T({ Page_Name = "Tab Mirage", Page_Title = "Tab Mirage" }),
    Race = Cz.T({ Page_Name = "Tab Upgrade Races V3", Page_Title = "Tab Upgrade Races V3" }),
    Drago = Cz.T({ Page_Name = "Tab Dragon Dojo", Page_Title = "Tab Dragon Dojo" }),
    Prehistoric = Cz.T({ Page_Name = "Tab Prehistoric", Page_Title = "Tab Prehistoric" }),
    Raids = Cz.T({ Page_Name = "Tab Fruit And Raid", Page_Title = "Tab Fruit And Raid" }),
    PlayerPVP = Cz.T({ Page_Name = "Tab PvP", Page_Title = "Tab PvP" }),
    Travel = Cz.T({ Page_Name = "Tab Teleport", Page_Title = "Tab Teleport" }),
    Shop = Cz.T({ Page_Name = "Tab Shop", Page_Title = "Tab Shop" }),
    Misc = Cz.T({ Page_Name = "Tab Miscellaneous", Page_Title = "Tab Miscellaneous" })
}

Tabs.Info:CreateSection("Thông Tin Chính")
Tabs.Info:CreateDiscordInvite({
    Name = "Orange Hub",
    Description = "Vào Discord Để Nhận Update Mới",
    Logo = "rbxassetid://104922707580804",
    Invite = "https://discord.gg/6McJU8HBa"
})
Tabs.Info:CreateSection("Trạng Thái Máy Chủ")
ScriptStatus = Tabs.Info:CreateParagraph({
    Title = "Ngày Phát Hành",
    Content = "20/5/2026"
})
Time = Tabs.Info:CreateParagraph({
    Title = "Múi Giờ",
    Content = ""
})
function UpdateOS()
...
Timmessss = Tabs.Info:CreateParagraph({
    Title = "Thời Gian",
    Content = ""
})
function UpdateTime()
...
Miragecheck = Tabs.Info:CreateParagraph({
    Title = "Đảo Bí Ẩn",
    Content = "Status: "
})
previousStatus = ""
...
Kitsunecheck = Tabs.Info:CreateParagraph({
    Title = "Đảo Cáo",
    Content = "Status: "
})
task.spawn(function()
...
CPrehistoriccheck = Tabs.Info:CreateParagraph({
    Title = "Đảo Rồng",
    Desc = "Status: "
})
task.spawn(function()
...
FrozenIsland = Tabs.Info:CreateParagraph({
    Title = "Đảo Leviathan",
    Content = "Status: "
})
task.spawn(function()
...
MobCakePrince = Tabs.Info:CreateParagraph({
...
CheckRip = Tabs.Info:CreateParagraph({
    Title = "Rip_Indra",
    Content = "Status: "
})
task.spawn(function()
...
CheckDoughKing = Tabs.Info:CreateParagraph({
    Title = "Dough King",
    Content = "Status: "
})
task.spawn(function()
...
EliteHunter = Tabs.Info:CreateParagraph({
    Title = "Elite Hunter",
    Content = "Status: "
})
task.spawn(function()
...
LegendarySword = Tabs.Info:CreateParagraph({
...
StatusBone = Tabs.Info:CreateParagraph({
    Title = "Xương",
    Content = ""
})
task.spawn(function()
...
AttackDropdown = Tabs.Main:CreateDropdown({
...
Tabs.Main:CreateSection({"Bug Report"})
...
Tabs.VS:CreateSection({"Visual"})
Tabs.VS:CreateButton({
...
Tabs.Main:CreateSection({"Farming"})
...
Tabs.Main:CreateSection({"Collect Chest"})
...
Tabs.Main:CreateSection({"Collect Berry"})
...
Tabs.Main:CreateSection({"Farm Elite Hunter"})

Process = Tabs.Main:CreateParagraph({
...
EliteHunter = Tabs.Main:CreateParagraph({
...
Tabs.Main:CreateSection({"Farming Cake"})
MobKilled = Tabs.Main:CreateParagraph({
    Title = "Hoàng Tử Bột:",
    Content = ""
})
task.spawn(function()
...
DoughKingFarm = Tabs.Main:CreateToggle({
...
HopDough = Tabs.Main:CreateToggle({
...
Tabs.Main:CreateSection({"Unlocked Dungeon"})

DouD = Tabs.Main:CreateToggle({
...
Tabs.Main:CreateSection({"Farming Bone"})

CheckingBone = Tabs.Main:CreateParagraph({
    Title = " Xương :",
    Content = ""
})
task.spawn(function()
...
Tabs.Main:CreateSection({"Tyrant of the Skies"})

TyrantStatus = Tabs.Main:CreateParagraph({
...
Tabs.Main:CreateSection({"Farm Material"})
...
Tabs.Main:CreateSection({"Farm Boss"})
...
-- BOSS STATUS LABEL
-- ==============================
BossStatus = Tabs.Main:CreateParagraph({
...
-- TOGGLE FARM BOSS
-- ==============================
FarmBossToggle = Tabs.Main:CreateToggle({
    Name = "Tự Động Đánh Boss",
    Flag = "FarmBossToggle",
    Description = "",
    Default = false,
...
Tabs.Main:CreateSection({"Farming Mastery"})
posMastery = {"Cake","Bone"}
Mastery_Config = Tabs.Main:CreateDropdown({
...
MasteryFruits = Tabs.Main:CreateToggle({
...
MasteryHealthSlider = Tabs.Main:CreateSlider({
...
MasteryGun = Tabs.Main:CreateToggle({
...
MasteryHealthSliderGun = Tabs.Main:CreateSlider({
    Name = "Phần Trăm Máu Kết Liễu",
...
MasteryGunDS = Tabs.Main:CreateToggle({
...
MasteryHealthSliderDS = Tabs.Main:CreateSlider({
    Name = "Phần Trăm Máu Kết Liễu",
...
MasterySword = Tabs.Main:CreateToggle({
...
Tabs.Settings:CreateSection({"Settings / Configure"})
...
HopToggle = Tabs.Settings:CreateToggle({
...
Byp = Tabs.Settings:CreateToggle({
...
AntiAFK = Tabs.Settings:CreateToggle({
    Name = "Chống Kick",
    Flag = "AntiAFK",
    Description = "",
    Default = true,
...
-- ESP TOGGLE UI
-- ==============================
Tabs.Settings:CreateSection("ESP | Định vị")
...
Tabs.Settings:CreateSection({"Stats Upgrade"})
...
StatsUpg = Tabs.Settings:CreateToggle({
Name = "Tự Động Melee", 
Flag = "StatsUpg",
Description = "", 
Default = false,
...
Tabs.Fish:CreateSection({"Fishing"})
...
Fishing = Tabs.Fish:CreateToggle({
...
Tabs.Quests:CreateSection({"Fish Slap"})
...
Tabs.Quests:CreateSection({"Tushita + Yama"})
...
Tabs.Quests:CreateSection({"Cursed Dual Katana"})
CheckCDK = Tabs.Quests:CreateParagraph({
...
Tabs.Quests:CreateSection({"True Triple Katana Sword"})
Tabs.Quests:CreateToggle({
...
Tabs.Quests:CreateSection({"Pole / God Enal's"})
Q = Tabs.Quests:CreateToggle({
...
Tabs.Quests:CreateSection({"Items Law/Order Sword"})
Q = Tabs.Quests:CreateToggle({
...
Tabs.Quests:CreateSection({"East Blue Misc"})
Q = Tabs.Quests:CreateToggle({
...
Tabs.Quests:CreateSection({"Rengoku Sword"})
Q = Tabs.Quests:CreateToggle({
...
Tabs.Quests:CreateSection({"Cavender + Twin Hooks + Bigmom"})
Q = Tabs.Quests:CreateToggle({
...
Tabs.Quests:CreateSection({"Buso/Aura Colours"})
Q = Tabs.Quests:CreateToggle({
...
Tabs.Quests:CreateSection({"Instinct / Observation"})
Q = Tabs.Quests:CreateToggle({
...
Tabs.Quests:CreateSection({"Rip_Indra True Form"})
Q = Tabs.Quests:CreateToggle({
...
Tabs.Mirage:CreateSection({"Đảo Bí Ẩn / Trăng Tròn"})
FullMOOn = Tabs.Mirage:CreateParagraph({
Title = "Trạng Thái Trăng Tròn",
Content = ""})
Ismirage = Tabs.Mirage:CreateParagraph({
...
Tabs.Mirage:CreateSection({"Skull Guitars / Misc"})
CheckSoul = Tabs.Mirage:CreateParagraph({
...
Tabs.Race:CreateSection({"Upgrade Races V3"})
...
Tabs.Race:CreateSection({"Trials Quest V4"})
CheckTier = Tabs.Race:CreateParagraph({
...
Tabs.Drago:CreateSection({"Dojo Quest & Drago Race"})
DojoQ = Tabs.Drago:CreateToggle({
...
BlazeEM = Tabs.Drago:CreateToggle({
...
Tabs.Drago:CreateSection({"Drago Trial"})
...
Toggle = Tabs.Drago:CreateToggle({
...
fireflower = Tabs.Drago:CreateToggle({
...
dragoTpVolcano = Tabs.Drago:CreateToggle({
...
bdrago = Tabs.Drago:CreateToggle({
...
UpTalon = Tabs.Drago:CreateToggle({
...
Tabs.Prehistoric:CreateSection({"Volcanic Magnet"})
...
Tabs.Prehistoric:CreateSection({"Prehistoric Island"})
Check_Volcano = Tabs.Prehistoric:CreateParagraph({
...
Patch = Tabs.Prehistoric:CreateToggle({
...
Tabs.SeaEvent:CreateSection({"Sea Event / Setting Sail"})
...
SPYING = Tabs.SeaEvent:CreateParagraph({
...
FloD = Tabs.SeaEvent:CreateParagraph({
...
Tabs.SeaEvent:CreateSection({"Entity Sea Event"})
...
Tabs.SeaEvent:CreateSection({"Kitsune Island / Event"})
Check_Kitsu = Tabs.SeaEvent:CreateParagraph({
...
Tabs.Raids:CreateSection({"Fruits Options"})
...
Tabs.Raids:CreateSection({"Dungeon Event / Raiding"})
RaidS = Tabs.Raids:CreateParagraph({
...
Tabs.Raids:CreateSection({"Raiding Menu"})
...
Tabs.Raids:CreateSection({"Dungeon Event"})
Dungoenvp = Tabs.Raids:CreateToggle({
...
Card=Tabs.Raids:CreateDropdown({
	Name = "Chọn Thẻ",
	Options=AllCards,
	MultiSelect=true,
	Flag="SelectCards",
...
Pickcard = Tabs.Raids:CreateToggle({
...
Tabs.PlayerPVP:CreateSection({"Player PvP"})
...
Tabs.Travel:CreateSection({"Travel - Worlds"})
...
Tabs.Travel:CreateSection({"Travel - Island"})
Location = {}
...
Tabs.Shop:CreateSection({"Shop Options"})
...
Tabs.Shop:CreateSection({"Fighting - Style"})
...
Tabs.Shop:CreateSection({"Accessory"})
Tabs.Shop:CreateButton({
Name = "Mua Tomoe Ring", 
Description = "",
Callback = function()
...
Tabs.Shop:CreateSection({"Accessory SeaEvent"})
Tabs.Shop:CreateButton({
...
Tabs.Shop:CreateSection({"Weapon World1"})
Tabs.Shop:CreateButton({
Name = "Mua Cutlass", 
Description = "",
Callback = function()
...
Tabs.Shop:CreateSection({"Fragments shop"})
Tabs.Shop:CreateButton({
...
Tabs.Misc:CreateSection({"Server - Function"})
...
Tabs.Misc:CreateSection({"Player Gui / Others"})
...
Tabs.Misc:CreateSection({"Graphics / Haki Stats"})
...
Tabs.Misc:CreateSection({"Configure - God"})
